...
When output names a domain concept, use the term as defined in `CONTEXT.md`. If the concept isn’t in the glossary yet, treat it as a signal for `/domain-modeling`.
